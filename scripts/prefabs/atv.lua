...
local function MakePreparedFood(data)
	...
	local function fn()
		...
		if spicename ~= nil then
			...
			inst.inv_image_bg = {atlas = "images/inventoryimages/atv_inv.xml", image = (data.basename or data.name)..".tex"}
		else
		...
		elseif data.basename ~= nil then
			...
			inst.components.inventoryitem.atlasname = "images/inventoryimages/atv_inv.xml"
		end
...
for k, v in pairs(require("atv_congthuc")) do
	table.insert(prefs, MakePreparedFood(v))
end
for k, v in pairs(require("atv_spicedfoods")) do
	table.insert(prefs, MakePreparedFood(v))
end
